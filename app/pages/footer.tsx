...
const Footer = () =>{
    return(
            ...
            <div className="col-1">
                    ...
                    <div className="loc-col">
                        ...
                        <div className="row">
                            ...
                            <div className="data">
                                ...
                                <div className="text"> Giporoso Remera, SareMatoro, Kigali RW</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="form-col">
                    ...
                    <div className="follow-col">
                        <h4>Follow Us</h4>
                        <div className="row-2">
                            <Link href=""><i className="bi bi-twitter icon"></i></Link>
                            <Link href=""><i className="bi bi-whatsapp icon"></i></Link>
                            <Link href=""><i className="bi bi-linkedin icon"></i></Link>
                            <Link href=""><i className="bi bi-instagram icon"></i></Link>
                            <Link href=""><i className="bi bi-facebook icon"></i></Link>
                        </div>
                    </div>
         </div>
        ...
        <button className="back-to-top"><div className="bi bi-chevron-up"></div></button>
        </footer>
    )
}
